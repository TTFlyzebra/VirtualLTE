...
public class NetworkActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, VirtualLTEManager.VirtualLTEListener {
    ...
    private void refreshView() {
        wifissid.setText(SystemPropTools.get("persist.sys.vlte.ssid", "HiWifi_4697BA"));
        wifipsk.setText(SystemPropTools.get("persist.sys.vlte.psk", "0755667788"));
